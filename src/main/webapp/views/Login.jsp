		...
		<div class="row align-items-center my-5">
			...
			<div class="col-lg-6 col-md-12 col-sm-12 mt-5">
				<div class="login-form">
					<form action="/login-validation" modelAttribute="loginForm"
						method="POST">
						...
						<div class="text-center w-100">
							<p class="text-muted font-weight-bold">
								Forgot Password <a href="/forgot_password"
									class="text-primary ml-2">Click here!</a>
							</p>
						</div>
						<!-- Divider Text -->
						<div
						...
						<div class="text-center social-btn">
							<a href="#" class="btn btn-secondary"><i
								class="fab fa-facebook"></i>&nbsp; Facebook</a> <a href="#"
								class="btn btn-info"><i class="fab fa-twitter"></i>&nbsp;
								Twitter</a> <a href="#" class="btn btn-danger"><i
					...
					<div class="text-center w-100">
						<p class="text-muted font-weight-bold">
							Don't have an account? <a href="signup" class="text-primary ml-2">Sign
								up here!</a>
						</p>
					</div>
				</div>
